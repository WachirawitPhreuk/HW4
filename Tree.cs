class Tree<T>
{
    ...
    private TreeNode<T> Traverse(TreeNode<T> currentTreeNode, ref int traverseStep)
    {
        ...
        /* เนื่องจากผมเขียนทฤษฎีได้ แต่ผมทำปฏิบัติไม่ได้ (ผมไม่เข้าใจเรื่องนี้จริงๆ orz
        )
        ต่อจาก Program
        หลังจากที่ใส่ค่า name และ days มาแล้ว ค่าทั้งสองจะถูกเก็บในตัวแปรใน TreeNode
        ทำการเก็บค่่าด้วยการ ref
        
        ใช้ if เมื่อมีคำใดซ้ำกับ name ในตัวเก็บ โปรแกรมจะหยุดทำงาน
